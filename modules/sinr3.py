...
class SINR3(nn.Module):
    ...
    def __init__(self,
        ...
        self.first_code_linear = nn.Linear(code_dim, hidden_dim)
    ...
    def forward(self, x: torch.Tensor, a: torch.Tensor) -> torch.Tensor:
        ...
        z = self.ftrs[0](x)
        out = self.out_linears[0](z) + torch.sum(self.first_code_linear(a) * z, dim=-1, keepdim=True)

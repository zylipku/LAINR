...
class SphereLoss:
    ...
    def __init__(self, phi_theta: torch.Tensor = None):
        '''
    ...
    def __call__(
            self, x: torch.Tensor, y: torch.Tensor, start_dim=-3, root=False, feature_sep=False, l1: float = None,
            l2: float = 1.) -> torch.Tensor:
        '''

...
class LAConfigs:
    ...
    ALL_DATASET_NAME = ['shallow_water', 'sw', 'era5']
    ALL_COMP_NAME = ['cae', 'aeflow', 'sinr']
    ALL_DYN_NAME = ['linreg', 'rezero', 'neuralode', 'none']
    ALL_LOSS_NAME = ['mse', 'skip', 'weighted']
    ALL_UQ_NAME = ['none', 'vacuous', 'diagonal', 'cholesky']
    ...
    def __init__(self, logger: logging.Logger,
        ...
        self.ed_need_cache = 'inr' in ed_name

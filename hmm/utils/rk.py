...
class RKdec:
    ...
    def __call__(self, func: Callable[..., torch.Tensor]):
        ...
        @decorator
        def rk_wrapper(func: Callable[..., torch.Tensor], *args, **kwargs):
        ...
        return rk_wrapper(func)

        def rk_func(self_, u: torch.Tensor, t: float, dt: float = 1.):

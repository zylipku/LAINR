...
from .la_dataset import DictDataset, PretrainDataset
...
class ShallowWater:
    ...
    def __init__(self, logger: logging.Logger,
        ...
        self.cached_data_tr_path = os.path.join(self.cfg.root_path, 'cached_data_tr.pt')
        self.cached_data_va_path = os.path.join(self.cfg.root_path, 'cached_data_va.pt')
        self.cached_data_ts_path = os.path.join(self.cfg.root_path, 'cached_data_ts.pt')
    ...
    def packing_from_raw(self, group: str) -> Dataset:
        ...
        return PretrainDataset(trajs=trajs,
                               coords={
